...
export class Example extends BaseScene {
	constructor() {
		...
		{ // legocar
			const body = this.makeLegoCar()
			this.legocar.add(body)
		}
	...
	makeLegoCar() {
		const body = new THREE.Mesh(new THREE.BoxGeometry(0.75, 0.5, 2.0), new THREE.MeshLambertMaterial({ color: 0x666666, transparent: true, opacity: 0.8 }))
		{ // stearing
			const steering = new THREE.Mesh(new THREE.BoxGeometry(0.25, 0.25, 0.05), new THREE.MeshLambertMaterial({ color: 0x333333 }))
			steering.position.set(-0.4, 0.3, 0.5)
			steering.rotation.x = Math.PI / 8
			steering.userData = {
				data: 'steering_wheel'
			}
		...
		{ // camera
			const camera = new THREE.Object3D()
			camera.position.set(0, 0.45, 0.15)
			camera.userData = {
				data: 'camera'
			}
			body.add(camera)
		...
		{ // sceats
			{
				...
				const doorObj1 = new THREE.Object3D()
				doorObj1.position.copy(seat.position)
				doorObj1.position.x -= 0.4
				doorObj1.position.y += 0.1
				doorObj1.position.z += 0.4
				const door1 = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.3, 0.5), new THREE.MeshLambertMaterial({ color: 0xffff00 }))
				door1.position.z = -0.25
				doorObj1.name = "door_1"
				doorObj1.userData = {
					name: "door_1"
				}
				doorObj1.add(door1)
				...
				const entryPoint1 = new THREE.AxesHelper()
				entryPoint1.position.copy(doorObj1.position)
				entryPoint1.position.x -= 0.4
				entryPoint1.position.y -= 0.5
				entryPoint1.position.z -= 0.4
				entryPoint1.name = 'entrance_1'
				entryPoint1.userData = {
					name: "entrance_1"
				}
				body.add(entryPoint1)

				const doorObj2 = new THREE.Object3D()
				doorObj2.position.copy(seat.position)
				doorObj2.position.x += 0.4
				doorObj2.position.y += 0.1
				doorObj2.position.z += 0.4
				const door2 = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.3, 0.5), new THREE.MeshLambertMaterial({ color: 0xffff00 }))
				door2.position.z = -0.25
				doorObj2.name = "door_2"
				doorObj2.userData = {
					name: "door_2"
				}
				doorObj2.add(door2)
				...
				const entryPoint = new THREE.AxesHelper()
				entryPoint.position.copy(doorObj2.position)
		...
		{ // collisions
			{
				const bodyColl = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
				bodyColl.scale.set(0.8, 0.48, 2.0)
				bodyColl.position.set(0, -0.06, 0)
				bodyColl.scale.multiplyScalar(0.5)
				bodyColl.userData = {
					data: "collision",
					shape: "box"
			...
			{
				const bodyColl = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
				bodyColl.position.z = -0.2
				bodyColl.position.y = 0.46
				bodyColl.scale.set(0.75, 0.49, 1.2)
				bodyColl.scale.multiplyScalar(0.5)
				bodyColl.userData = {
					data: "collision",
					shape: "box"
			...
			}
			{
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(-0.2, 0, 0.8)
					bodyColl.scale.multiplyScalar(0.225)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
					}
			...
			}
			{
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(-0.2, 0, -0.9)
					bodyColl.scale.multiplyScalar(0.225)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
			...
			}
			{
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(-0.2, 0, 0.2)
					bodyColl.scale.multiplyScalar(0.225)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
			...
			}
			{
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(-0.2, 0, -0.4)
					bodyColl.scale.multiplyScalar(0.225)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
			...
			}
			{
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(-0.2, 0.2, 0.1)
					bodyColl.scale.multiplyScalar(0.225)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
			...
			}
			{
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(-0.2, 0.2, -0.7)
					bodyColl.scale.multiplyScalar(0.225)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
				...
				}
				{
					const bodyColl = new THREE.Mesh(new THREE.SphereGeometry(2), new THREE.MeshLambertMaterial({ color: 0x666666, wireframe: true }))
					bodyColl.position.set(0.2, 0.2, -0.7)
					bodyColl.scale.multiplyScalar(0.2)
					bodyColl.userData = {
						shape: "sphere",
						data: "collision"
					}
