...
export const rendererConfig: Configuration = {
	...
	resolve: {
		alias: {
			...
			'@World': path.resolve(__dirname, '../../dist/@World/index.js'),
			'@WorldClient': path.resolve(__dirname, '../../dist/@WorldClient/index.js'),
			'@WorldServer': path.resolve(__dirname, '../../dist/@WorldServer/index.js'),
		},
